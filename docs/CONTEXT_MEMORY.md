...
- The first submitted node must be the daily puzzle start player.
...
- If the last club can connect to the target player, the puzzle is considered solved.
- If the chain ends on the target player, the puzzle is also considered solved.
